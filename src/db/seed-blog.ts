...
const articles = [
  {
    ...
    seoKeywords: "gestione ticket riparazione, software ticket centro riparazione, gestionale smartphone riparazione",
  },
  {
    ...
    seoKeywords: "GDPR centro riparazione, privacy clienti riparazione, consenso GDPR smartphone",
  },
  {
    ...
    seoKeywords: "registro usato dispositivi, obblighi compravendita usato, registro acquisti smartphone",
  },
  {
    ...
    seoKeywords: "QR tracking riparazione, tracciamento ticket cliente, recensioni google centro riparazione",
  },
  {
    ...
    seoKeywords: "cassa POS centro riparazione, incasso riparazioni software, report Z gestionale",
  },
  {
    ...
    seoKeywords: "firma digitale modulo accettazione riparazione, firma elettronica tablet, eIDAS centro riparazione",
  },
];
...
async function main() {
  ...
  console.log(`Done. ${inserted} inserted, ${articles.length - inserted} skipped.`);
  process.exit(0);
}
